...
<!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Ubah Email Dan Username</h1>
          <p class="mb-4"></p>
          <?php if(isset($exist)){
           if ($exist=='username') {
            ?>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary text-center">Ubah Email Dan Username</h6>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                <div class="col">
                  <input type="text" name="email" class="form-control" required value="<?php echo $this->session->userdata('email'); ?>">
                </div>
              </div>
              <br>
              <div class="row">
