                    ...
                    <?php if ($tabel != false) {
                      ...
                      foreach ($tabel as $tb) {
                        ...
                        <tr>
                          ...
                          <form action="<?php echo base_url('pengguna/admin/produksi/produk/edit');?>" method="POST">
                            <input type="hidden" name="id" value="<?php echo $tb->id; ?>">
                            <input type="hidden" name="kode" value="<?php echo $tb->kode; ?>">
                            <input type="submit" class="btn btn-success btn-user btn-block" name="picture" value="Ubah">
                          </form>
                          </td>
                          ...
                          <td>
                            <form action="<?php echo base_url('pengguna/admin/produksi/produk/edit');?>" method="POST">
                              <input type="hidden" name="id" value="<?php echo $tb->id; ?>">
                              <input type="hidden" name="kd_prdk" value="<?php echo $tb->kode; ?>">
