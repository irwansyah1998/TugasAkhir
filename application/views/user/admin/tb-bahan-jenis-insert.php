...
<!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tabel Jenis Bahan - Insert</h1>
          <p class="mb-4"></p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary text-center">Masukkan Jenis Bahan</h6>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col">
                  <h6 class="m-0 font-weight-bold">Kode Jenis Bahan :</h6>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <input placeholder="Masukkan Jenis Bahan..." type="text" name="jns_bhn" value="" class="form-control" required>
                </div>
                <div class="col">
