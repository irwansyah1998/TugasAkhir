<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tabel Bahan - Edit Nama Bahan</h1>
            <a href="<?php echo base_url('pengguna/admin/tabel/bahan/nama/tambah');?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-arrow-right fa-sm text-white-50"></i> Tambah Data <i class="fas fa-arrow-left fa-sm text-white-50"></i></a>
          </div>
                ...
                <table id="dataTable" class="table table-bordered dataTable" role="grid" aria-describedby="dataTable_info" style="width:100%" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="<?php echo base_url('pengguna/admin/tabel/bahan/nama/edit');?>" method="POST">
