<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="<?php echo base_url('pengguna/manager/setting/akun/tambah');?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-arrow-right fa-sm text-white-50"></i> Tambah Pengguna <i class="fas fa-arrow-left fa-sm text-white-50"></i></a>
          </div>
          <?php if(isset($akun)){ ?>
          <div class="row">
                  <div class="col-12">
                ...
                <table id="dataTable" class="table table-bordered dataTable" role="grid" aria-describedby="dataTable_info" style="width:100%" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="<?php echo base_url('pengguna/manager/setting/akun/edit');?>" method="POST">
                          ...
                          <select name="jns_usr" class="form-control" <?php if ($tb->email==$this->session->userdata('email') && $tb->username == $this->session->userdata('nama')){echo "disabled";} ?>>
                            ...
                            <option value="Promosi"<?php if($tb->hak_akses=='Promosi'){echo "selected";} ?>>Promosi</option>
