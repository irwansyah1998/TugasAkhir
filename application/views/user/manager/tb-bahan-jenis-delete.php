<div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tabel Jenis Bahan - Hapus</h1>
          <p class="mb-4"></p>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form action="<?php echo base_url('pengguna/admin/tabel/bahan/jenis/insup');?>" method="POST">
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <input class="btn btn-danger btn-user btn-block" type="submit" name="delete" value="Ya, Saya Yakin" >
              </form>
              <br>
              <a href="<?php echo base_url('pengguna/admin/tabel/bahan/nama/');?>" class="btn btn-success btn-user btn-block">
